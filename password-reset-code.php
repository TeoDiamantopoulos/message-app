...
function send_password_reset($get_name, $get_email, $token)
{
    ...
    $mail->Username = 'example@example.com'; //your email
    $mail->Password = '************'; //SMTP password

    $mail->SMTPSecure = "tls"; //Enable implicit TLS encryption 
    $mail->Port = 587;

    $mail->setFrom("example@example.com", $get_name);
    ...
    <br/></br>
    <a href='http://localhost/message/password-change.php?token=$token&email=$get_email'> Click Me</a> 
    ";
